...
async function toggleAutoStart(checkbox) {
    ...
    try {
        ...
        if(data.status === 'success') {
            msg.textContent = isEnabled ? 'WinToolKit iniciar� com o Windows.' : 'Inicializa��o autom�tica desativada.';
        ...
        msg.textContent = 'Erro ao alterar configura��o.';
